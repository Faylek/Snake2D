...
//dir - указывает направление змейки и num - колво плиток змейки
int dir = 2; int num = 4;
...
int main(){
    ...
    Texture sn;
    sn.loadFromFile("images/snake.png");
    Sprite snake(sn);

    Texture ap;
    ap.loadFromFile("images/apple.png");
    Sprite apple(ap);
    f.x = 10; f.y = 10;
    ...
    Music music;
    music.openFromFile("sounds/fon.wav");
    music.play();
    
    Clock clock;
    float timer = 0; float delay = 0.1;
